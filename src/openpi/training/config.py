...
import openpi.policies.gim_dual_arm_policy as gim_dual_arm_policy
...
@dataclasses.dataclass(frozen=True)
class GimDualArmLeRobotDataConfig(DataConfigFactory):
    """Data config for GIM 6-DOF bimanual arm datasets."""
    ...
    def create(self, assets_dirs: pathlib.Path, model_config: _model.BaseModelConfig) -> DataConfig:
        ...
        data_transforms = _transforms.Group(
            inputs=[
                gim_dual_arm_policy.GimDualArmInputs(
                    action_dim=model_config.action_dim, model_type=model_config.model_type
                )
            ],
            outputs=[gim_dual_arm_policy.GimDualArmOutputs()],
        )
